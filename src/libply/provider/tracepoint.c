...
static int tracepoint_dynamic_ir_post(const struct func *func, struct node *n,
				      struct ply_probe *pb)
{
	struct node *ctx, *arg;
	struct ir *ir = pb->ir;
...
static int tracepoint_dynamic_rewrite(const struct func *func, struct node *n,
				      struct ply_probe *pb)
{
	struct node *ctx, *arg;
...
static int tracepoint_dynamic_type_infer(const struct func *func, struct node *n)
{
...
static struct func tracepoint_dynamic_func = {
	.name = "dyn",
	.type = &t_vargs_func,
	.type_infer = tracepoint_dynamic_type_infer,
	.rewrite = tracepoint_dynamic_rewrite,
	.ir_post = tracepoint_dynamic_ir_post,
};
